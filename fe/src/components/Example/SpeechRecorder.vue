...
<template>
  <div class="flex items-center justify-center">
    ...
    <button @click="toggleRecording"
      ...
      class="w-24 h-24 flex items-center justify-center rounded-full border-4 text-white text-2xl focus:outline-none transition hover:scale-110 shadow-md"
    ...
    <!-- Speech Visualizer -->
    <SpeechVisualizer :barColor="recorderStore.isRecording ? '#457b9d' : '#f1faee'" :width="300" :height="200"
      :barWidth="10" :barGap="8" :barCount="10" />
    ...
    <div v-if="showConfirmation" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div class="bg-white p-12 rounded-lg shadow-xl w-2/3  md:w-1/2 text-center">
        <p class=" text-lg font-semibold mb-10 md:mb-20 md:text-2xl">Během zadávání výsledků hlasem budou pro zlepšení této aplikace Vaše hlasové odpovědi
          ukládány</p>
